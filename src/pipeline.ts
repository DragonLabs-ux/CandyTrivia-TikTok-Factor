...
const imagePrompts = [
  'Vertical 9:16 premium glossy 3D trivia-video background in the same high-impact style as RankRush: cinematic studio lighting, sharp realistic candy objects, rich saturated colors, deep black or clean dark gradient background, bold quiz-show energy, polished commercial 3D render, high contrast, crisp reflections, premium app-ad quality. Feature glossy translucent gumballs and jewel-like jelly beans around the outer edges with generous clean center space for overlay text. Keep it modern and exciting, not flat, not childish, not blurry. Do not include logos, brand names, characters, people, captions, UI, packaging, letters, numbers, labels, symbols, or text baked into the image.',
  'Vertical 9:16 premium glossy 3D trivia-video background in the same high-impact style as RankRush: cinematic studio lighting, sharp realistic candy objects, rich saturated colors, deep black or clean dark gradient background, bold quiz-show energy, polished commercial 3D render, high contrast, crisp reflections, premium app-ad quality. Feature sculptural spiral lollipops, glossy hard candies, and sour candy crystals clustered near the top and bottom edges with generous clean center space for overlay text. Keep it modern and exciting, not flat, not childish, not blurry. Do not include logos, brand names, characters, people, captions, UI, packaging, letters, numbers, labels, symbols, or text baked into the image.',
  'Vertical 9:16 premium glossy 3D trivia-video background in the same high-impact style as RankRush: cinematic studio lighting, sharp realistic candy objects, rich saturated colors, deep black or clean dark gradient background, bold quiz-show energy, polished commercial 3D render, high contrast, crisp reflections, premium app-ad quality. Feature glossy gummy bears, faceted hard candies, and rich chocolate squares around the perimeter with generous clean center space for overlay text. Keep it modern and exciting, not flat, not childish, not blurry. Do not include logos, brand names, characters, people, captions, UI, packaging, letters, numbers, labels, symbols, visual clues to trivia answers, or text baked into the image.',
] as const;
